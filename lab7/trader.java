...
public class trader {
    ...
    public void convertToPDF()  throws IOException, FOPException, TransformerException {
        // the XSL FO file
        File xsltFile = new File("trader.xsl");
        // the XML file which provides the input
        StreamSource xmlSource = new StreamSource(new File("trader.xml"));
        ...
        // Setup output
        OutputStream out;
        out = new java.io.FileOutputStream("trader.pdf");
    ...
    public void convertToFO()  throws IOException, FOPException, TransformerException {
        ...
        out = new java.io.FileOutputStream("trader.fo");
